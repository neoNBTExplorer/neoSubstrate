...
/// </summary>
/// <remarks>
///     By default, all known MC item types are already defined and registered, assuming Substrate
...
///     in the <see cref="ItemInfo" /> class.
/// </remarks>
public class ItemInfo
{
    ...
    /// </summary>
    public static ICacheTable<ItemInfo> ItemTable => _itemTableCache;
    ...
    {
        var list = new List<ItemInfo>(_itemTable.Values);
