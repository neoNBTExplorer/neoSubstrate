...
public interface IPropertyBlock : IBlock
{
    ...
    ///     Thrown when the <see cref="TileEntity" /> being passed is of the wrong type for the
    ///     given block.
    /// </exception>
    /// <exception cref="InvalidOperationException">
    ///     Thrown when the given block is of a type that does not support a
    ///     <see cref="TileEntity" /> record.
    /// </exception>
    ...
    ///     Thrown when the block type requests a <see cref="TileEntity" /> that has
    ///     not been registered with the <see cref="TileEntityFactory" />.
    /// </exception>
...
/// <summary>
///     Provides a common interface for block containers that provide global management, extended through Version 1.0
///     capabilities.
/// </summary>
