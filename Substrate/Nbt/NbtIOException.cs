...
/// </summary>
/// <remarks>
///     In most cases, the <see cref="Exception.InnerException" /> property will contain more detailed information on the
///     error that occurred.
/// </remarks>
[Serializable]
public class NbtIOException : SubstrateException
{
    ...
    /// <summary>
    ///     Initializes a new instance of the <see cref="NbtIOException" /> class with a custom error message and a reference
    ///     to
