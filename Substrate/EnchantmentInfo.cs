...
///     New enchantment types may be created and used at runtime, and will automatically populate various static lookup
///     tables
///     in the <see cref="EnchantmentInfo" /> class.
/// </remarks>
public class EnchantmentInfo
{
    ...
    static EnchantmentInfo()
    {
        ...
        ProjectileProtection = new EnchantmentInfo(EnchantmentType.PROJECTILE_PROTECTION, "Projectile Protection")
            .SetMaxLevel(4);
    ...
    {
        var list = new List<EnchantmentInfo>(_enchTable.Values);
    ...
    private class CacheTableDict<T> : ICacheTable<T>
    {
        ...
        public T this[int index]
        {
            ...
            {
                T val;
                if (_cache.TryGetValue(index, out val)) return val;
                return default;
            }
        }
