...
/// <summary>
///     A collection of static methods that can be hooked into <see cref="NbtVerifier" /> events for logging NBT errors to
///     the console.
/// </summary>
public static class VerifierLogger
{
    ...
    {
        Console.WriteLine("Invalid Tag Type Error: '{0}' has type '{1}', expected '{2}'", e.TagName, e.Tag.GetTagType(),
            e.Schema);
    ...
    {
        Console.WriteLine("Invalid Tag Value Error: '{0}' of type '{1}' is set to invalid value '{2}'", e.TagName,
            e.Tag.GetTagType(), e.Tag);
