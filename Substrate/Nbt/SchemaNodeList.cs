...
{
    /// <summary>
    ///     Constructs a new <see cref="SchemaNodeList" /> representing a <see cref="TagNodeList" /> named
    ///     <paramref name="name" /> containing items of type <paramref name="type" />.
    /// </summary>
    ...
    /// <summary>
    ///     Constructs a new <see cref="SchemaNodeList" /> representing a <see cref="TagNodeList" /> named
    ///     <paramref name="name" /> containing <paramref name="length" /> items of type <paramref name="type" />.
    /// </summary>
    /// <param name="name">The name of the corresponding <see cref="TagNodeList" />.</param>
    /// <param name="type">The type of items contained in the corresponding <see cref="TagNodeList" />.</param>
    ...
    /// <summary>
    ///     Constructs a new <see cref="SchemaNodeList" /> representing a <see cref="TagNodeList" /> named
    ///     <paramref name="name" /> containing items of type <paramref name="type" /> matching the given schema.
    /// </summary>
    /// <param name="name">The name of the corresponding <see cref="TagNodeList" />.</param>
    /// <param name="type">The type of items contained in the corresponding <see cref="TagNodeList" />.</param>
    /// <param name="subschema">
    ///     A <see cref="SchemaNode" /> representing a schema to verify against items contained in the
    ///     corresponding <see cref="TagNodeList" />.
    /// </param>
    ...
    /// <summary>
    ///     Constructs a new <see cref="SchemaNodeList" /> representing a <see cref="TagNodeList" /> named
    ///     <paramref name="name" /> containing <paramref name="length" /> items of type <paramref name="type" /> matching the
    ///     given schema.
    /// </summary>
    /// <param name="name">The name of the corresponding <see cref="TagNodeList" />.</param>
    /// <param name="type">The type of items contained in the corresponding <see cref="TagNodeList" />.</param>
    ...
    /// <summary>
    ///     Gets a <see cref="SchemaNode" /> representing a schema that items contained in the corresponding
    ///     <see cref="TagNodeList" /> should be verified against.
    /// </summary>
    ...
    /// </summary>
    /// <returns>
    ///     A <see cref="TagNodeList" /> with a sensible default value.  If a length is specified, default child
    ///     <see cref="TagNode" /> objects of the necessary type will be created and added to the <see cref="TagNodeList" />.
    /// </returns>
    public override TagNode BuildDefaultTree()
    {
        if (Length == 0) return new TagNodeList(Type);

        var list = new TagNodeList(Type);
        for (var i = 0; i < Length; i++) list.Add(SubSchema.BuildDefaultTree());
