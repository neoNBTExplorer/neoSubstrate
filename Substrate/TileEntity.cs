...
///     capture any of the custom data fields that make Tile Entities useful in the first place.  It is however still
///     possible to
///     create instances of <see cref="TileEntity" /> objects, which may allow for graceful handling of unknown Tile
///     Entities.
/// </remarks>
public class TileEntity : INbtObject<TileEntity>, ICopyable<TileEntity>
{
    ...
    public TileEntity(TileEntity te)
    {
        ...
        if (te.Source != null) Source = te.Source.Copy() as TagNodeCompound;
    }
