...
public interface IRegion : IChunkContainer
{
    ...
    /// </summary>
    /// <returns>
    ///     Gets the path of the region's file based on the <see cref="IRegionManager" />'s region path and the region's
    ///     on filename.
    /// </returns>
    string GetFilePath();
    ...
    /// <summary>
    ///     Saves an <see cref="NbtTree" /> for a chunk back to the region's data store at the given local coordinates and with
    ///     the given timestamp.
    /// </summary>
    /// <param name="lcx">The local X-coordinate of the chunk within the region.</param>
    /// <param name="lcz">The local Z-coordinate of the chunk within the region.</param>
    ...
    ///     instead.  This allows any <see cref="Region" /> to perform a similar task to <see cref="RegionChunkManager" />, but
    ///     with a
    ...
    /// <summary>
    ///     Creates a new chunk at the given local coordinates relative to this region and returns a new
    ///     <see cref="ChunkRef" /> for it.
    /// </summary>
    /// <param name="lcx">The local X-coordinate of a chunk relative to this region.</param>
    /// <param name="lcz">The local Z-coordinate of a chunk relative to this region.</param>
...
public interface IRegionContainer
{
    ...
    /// <param name="rz">The global Z-coordinate of a region.</param>
    /// <returns>
    ///     A new empty <see cref="IRegion" /> object for the given coordinates, or an existing <see cref="IRegion" /> if
    ///     one exists.
    /// </returns>
