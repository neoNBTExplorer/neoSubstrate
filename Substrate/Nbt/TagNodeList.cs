...
public sealed class TagNodeList : TagNode, IList<TagNode>
{
    ...
    /// </summary>
    public TagType ValueType { get; private set; } = TagType.TAG_END;
    ...
    public override TagNode Copy()
    {
        ...
        foreach (var item in _items) list.Add(item.Copy());
        return list;
    }
    ...
    /// </summary>
    /// <param name="match">
    ///     The <see cref="Predicate{TagNode}" /> delegate that defines the conditions of the subnode to search
    ///     for.
    /// </param>
    ...
    /// <summary>
    ///     Searches for the specified subnode and returns the zero-based index of the first occurrence within the entire
    ///     node's list.
    /// </summary>
    ...
    /// <summary>
    ///     Copies the entire node's list to a compatible one-dimensional array, starting at the specified index of the target
    ///     array.
    /// </summary>
    /// <param name="array">
