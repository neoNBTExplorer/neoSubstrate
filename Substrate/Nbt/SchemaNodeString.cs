...
{
    /// <summary>
    ///     Constructs a new <see cref="SchemaNodeString" /> representing a <see cref="TagNodeString" /> named
    ///     <paramref name="name" />.
    /// </summary>
    ...
    /// <summary>
    ///     Constructs a new <see cref="SchemaNodeString" /> representing a <see cref="TagNodeString" /> named
    ///     <paramref name="name" /> set to <paramref name="value" />.
    /// </summary>
    /// <param name="name">The name of the corresponding <see cref="TagNodeString" />.</param>
    ...
    /// <summary>
    ///     Constructs a new <see cref="SchemaNodeString" /> representing a <see cref="TagNodeString" /> named
    ///     <paramref name="name" /> with maximum length <paramref name="length" />.
    /// </summary>
    /// <param name="name">The name of the corresponding <see cref="TagNodeString" />.</param>
    ...
    /// </summary>
    public bool HasMaxLength => Length > 0;

    /// <summary>
    ///     Constructs a default <see cref="TagNodeString" /> satisfying the constraints of this node.
    /// </summary>
    /// <returns>
    ///     A <see cref="TagNodeString" /> with a sensible default value.  If this node represents a particular string,
    ///     the <see cref="TagNodeString" /> constructed will be set to that string.
    /// </returns>
    public override TagNode BuildDefaultTree()
    {
        if (Value.Length > 0) return new TagNodeString(Value);
