...
{
    private readonly List<OpenWorldCallback> _handlers;
    ...
    /// <summary>
    ///     Adds an <see cref="OpenWorldCallback" /> delegate that can open a world and return a corresponding
    ///     <see cref="NbtWorld" /> object.
    /// </summary>
