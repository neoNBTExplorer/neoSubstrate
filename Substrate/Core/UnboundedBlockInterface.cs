...
public interface ILitBlockCollection : IBlockCollection
{
    ...
    /// <summary>
    ///     Gets the Y-coordinate of the lowest block with unobstructed view of the sky at the given coordinates within an
    ///     unbounded block container.
    /// </summary>
    /// <param name="x">The global X-coordinate of a block.</param>
    /// <param name="z">The global Z-coordinate of a block.</param>
    ...
    /// <summary>
    ///     Sets the Y-coordinate of the lowest block with unobstructed view of the sky at the given coordinates within an
    ///     unbounded block container.
    /// </summary>
    /// <param name="x">The global X-coordinate of a block.</param>
    /// <param name="z">The global Z-coordinate of a block.</param>
...
public interface IPropertyBlockCollection : IBlockCollection
{
    ...
    /// <summary>
    ///     Deletes a <see cref="TileEntity" /> record associated with a block within an unbounded block container, if it
    ///     exists.
    /// </summary>
    /// <param name="x">The global X-coordinate of a block.</param>
    /// <param name="y">The global Y-coordinate of a block.</param>
