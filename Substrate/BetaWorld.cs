...
public class BetaWorld : NbtWorld
{
    ...
    private readonly Dictionary<string, BetaRegionManager> _regionMgrs;
    ...
    {
        var world = new BetaWorld().OpenWorld(path);
    ...
    {
        var world = new BetaWorld().CreateWorld(path);
        world._prefCacheSize = cacheSize;
    ...
    private void OpenDimension(string dim)
    {
        ...
        var rm = new BetaRegionManager(path, cc);
